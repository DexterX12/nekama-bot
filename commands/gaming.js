...
module.exports = {
    ...
    .setName('gaming')
    .setDescription('Haz saber que estás jugando solo o con tu amigo.')
	.addUserOption(option =>
		...
		.setRequired(false)),
    aliases: ['gaming'],
    description: 'Haz saber que estás jugando solo o con tu amigo. \n\n_¡Juega conmigo, te aseguro que no juego mal!_',
